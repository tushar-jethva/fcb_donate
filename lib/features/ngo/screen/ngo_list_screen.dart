                ...
                : GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        onTap: () {
                          Navigator.pushNamed(
                              context, NgoDetailScreen.routeName,
                              arguments:{'ngo':widget.ngos[index],'isSearch':false});
                        },
                        child: NgoDetailsCard(
                          img: widget.ngos[index].ngo_photo,
