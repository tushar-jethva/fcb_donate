...
class _MyNgoCardState extends State<MyNgoCard> {
  ...
  navigateToNgoScreen(Ngo n) {
    Navigator.pushNamed(context, NgoDetailScreen.routeName,
        arguments: {'ngo': n, 'isSearch': false});
  }
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          InkWell(
                            onTap: () {
                              navigateToNgoScreen(ngos![0]);
                            },
                            child: MySeeNGOCard(
                              img: ngos![0].ngo_photo ??
                                  "https://www.ngoregistration.org/wp-content/uploads/2018/06/NGO.jpg",
                              name: ngos![0].ngo_name,
                              area: ngos![0].area,
                            ),
                          ),
                          InkWell(
                            onTap: () {
                              navigateToNgoScreen(ngos![1]);
                            },
                            child: MySeeNGOCard(
                              img: ngos![1].ngo_photo ??
                                  "https://www.ngoregistration.org/wp-content/uploads/2018/06/NGO.jpg",
                              name: ngos![1].ngo_name,
                              area: ngos![1].area,
                            ),
                          ),
                        ],
